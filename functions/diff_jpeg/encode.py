...
def patchify_8x8(input: Tensor) -> Tensor:
    ...
    """
    # Get input shape
    B, H, W = input.shape  # type: ignore # type: int, int, int
...
def dct_8x8(input: Tensor) -> Tensor:
    ...
    x, y, u, v = torch.meshgrid(index, index, index, index)  # type: ignore # type: Tensor, Tensor, Tensor, Tensor
...
def jpeg_encode(
    ...
    input_y, input_cb, input_cr = chroma_subsampling(image_ycbcr)  # type: ignore # type: Tensor, Tensor, Tensor
    # Patchify, DCT, and rounding
    input_y, input_cb, input_cr = patchify_8x8(input_y), patchify_8x8(input_cb), patchify_8x8(input_cr)
    dct_y, dct_cb, dct_cr = dct_8x8(input_y), dct_8x8(input_cb), dct_8x8(input_cr)  # type: ignore # type: Tensor, Tensor, Tensor
